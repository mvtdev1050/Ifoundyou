<aside id="menubar" class="menubar light">
    ...
    <div class="media">
      <div class="media-left">
        <div class="avatar avatar-md avatar-circle">
          <a href="javascript:void(0)"><img class="img-responsive" src="{{ asset('public/assets/images/admin.png') }}" alt="avatar"/></a>
        </div><!-- .avatar -->
      </div>
          ...
          <ul>
            <li class="dropdown">
              <a href="javascript:void(0)" class="dropdown-toggle usertitle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <small><?php if(!empty(Auth::user()->Dispensary->name)) { echo  Auth::user()->Dispensary->name; } else {
                	echo "Dispensary";
                	} ?></small>
              ...
              <ul class="dropdown-menu animated flipInY">
                <li>
                  <a class="text-color" href="{{ url('/dispensary/dashboard') }}">
                    <span class="m-r-xs"><i class="fa fa-home"></i></span>
                    <span>Home</span>
                  </a>
                </li>
                <li>
                  <a class="text-color" href="{{ url('/dispensary/profile') }}">
  ...
  <div class="menubar-scroll">
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
        ...
        <li>
          <a href="{{ url('/dispensary/dispensaries') }}" >
            <i class="menu-icon zmdi zmdi-view-dashboard zmdi-hc-lg"></i>
            <!-- <i class="fa fa-medkit  zmdi-hc-lg" aria-hidden="true"></i> -->
            <span class="menu-text">Dispensaries</span>
          </a>
        </li>
       ...
       <!--  <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
            ...
            <span class="menu-text">Dispensary</span>
          </a>
          <ul class="submenu">
        ...
        <!-- <li>
          <a href="{{ url('/products/allProducts') }}">
 ...
 -->
        <li>
          <a href="{{ url('/employee/allEmployees') }}" >
         ...
         <li>
          <a href="{{ url('/category/stock') }}">
            <i class="menu-icon zmdi zmdi-file-text zmdi-hc-lg"></i>
            <span class="menu-text">Stock Detail</span>
          </a>
        </li>
         ...
         <li>
          <a href="{{ url('/products/transactions') }}">
