    ...
    <div class="ibp_dashboard_cont">
       @if (session('custom_success'))
             ...
             <div class="alert alert-danger alert-dismissible" role="alert">
              ...
              @endif
        <form id="ProductForm" action="{{ url('admin/saveNewPage') }}" method="Post" enctype="multipart/form-data">
        <div class="outr_box_shadow">
        {{csrf_field()}}
          <h2 class="h2_product"><span>Add New Page</span></h2>
          <div style="margin-top:30px" class="box_shadow_inr col-md-12 col-xs-12 col-sm-12">
           <div class="form-group">
            <label class="control-label">Title</label>
            <input placeholder="Title" value="{{ old('title') }}" name="title" class="form-control" type="text">
          </div>
             <h4 class="h4_product">Description</h4>
            <div class="form-group">
              <textarea name="description" placeholder="Description" class="form-control" colspan="10" rowspan="6"></textarea>
            </div> 
            <div class="form-group">
            ...
            <ul>
              <li>
               <input type="checkbox" class="menutab" name="menu[]" value="header-menu"/><span class="menutabSpan">Header menu</span>
              </li>
              <li>
                <input type="checkbox" class="menutab" name="menu[]" value="footer-menu"/><span class="menutabSpan">Footer menu</span>
              </li>
            </ul>
          </div>
           <div class="form-group">
            <label class="control-label">Order</label>
            <input placeholder="Order" value="{{ old('order_number') }}" type="number" name="order_number" class="form-control" min="0" step="1" data-bind="value:replyNumber">
          </div>
           <div class="form-group">
