  ...
  <div class="wrap">
    <section class="app-content">
      <div class="ibp_dashboard_cont_inr">
        ...
        <form id="ProductForm" action="{{ url('/admin/save-new-user') }}" method="Post" enctype="multipart/form-data">
          <div class="outr_box_shadow">
            {{csrf_field()}}
            <h2 class="h2_product"><span>New user</span></h2>
            <div style="margin-top:30px" class="box_shadow_inr col-md-12 col-xs-12 col-sm-12">
             <div class="form-group">
              <label class="control-label">First Name</label>
              <input placeholder="First Name" value="{{ old('first_name') }}" name="first_name" class="form-control" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">Last Name</label>
              <input placeholder="Last Name" value="{{ old('last_name') }}" name="last_name" class="form-control" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">Email</label>
              <input placeholder="Email" value="{{ old('email') }}" name="email" class="form-control" type="email">
            </div>
            <div class="form-group">
              <label class="control-label">Username</label>
              <input placeholder="Username" value="{{ old('username') }}" name="username"  class="form-control" type="text">
            </div>
       {{--      <div class="form-group">
                ...
                <span class="btn default btn-file">
                  <span class="fileinput-new">
                    ...
                    <span class="fileinput-exists">
                      Change </span>
                      <input name="new_image" type="file" class="changeButtonFile">
                    </span>
              ...
              <div class="marginBot col-md-12 col-xs-12 col-sm-12">
                <button type="submit" class="btn mw-md btn-primary pull-right">Save</button>
              </div>
            </div>
